 ...
 * This is NOT an efficient solution/method, because using Locks in "for loop" (many "lock()"/"unlock()").
 */

public class PiCalcGlobalSumLock {
	
	public static double sumPi; // Global shared counter to calculate total result
