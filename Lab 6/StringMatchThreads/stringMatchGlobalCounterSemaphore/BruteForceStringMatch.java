...
public class BruteForceStringMatch {
	...
	public static int matchCount = 0; // Shared counter for matches
	public static Semaphore mutex = new Semaphore(1); // Global Semaphore
    ...
    public static void main(String args[]) throws IOException {
        ...
        // Thread execution   
     	for (int i = 0; i < numThreads; i++) {
     		threads[i] = new ThreadMatch(i, numThreads, text, pattern, match, m, matchLength);
     		threads[i].start();
     	}
